...
//-------------------------------------------------------------
 ...
 //---------------------------------------------------------
  ...
  if(greyscale_conversion_success == JPEG_OK){
...
//-------------------------------------------
  ...
  ImageQuality processing_results;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  HAL_Delay(500); // just makes it easier to put a breakpoint here
