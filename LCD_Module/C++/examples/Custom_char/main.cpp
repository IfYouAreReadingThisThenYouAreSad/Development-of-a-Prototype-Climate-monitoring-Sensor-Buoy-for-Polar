...
extern "C" int main(void)
{
  ...
  // Set the backlight brightness to 50% (value range from 0 to 100)
     ...
     lcd.create_char(0, aUmlaut);  // Create 'ä' character at position 0
     lcd.create_char(1, oUmlaut);  // Create 'ö' character at position 1
     lcd.create_char(2, clock);    // Create clock character at position 2
     lcd.create_char(3, heart);    // Create heart character at position 3
     lcd.create_char(4, duck);     // Create duck character at position 4
     lcd.create_char(5, check);    // Create check mark character at position 5
     lcd.create_char(6, cross);    // Create cross mark character at position 6
     lcd.create_char(7, retarrow); // Create right arrow character at position 7

     // Display custom characters on the LCD screen
     for (int i = 0; i < 8; i++) {  // Loop through custom characters 0-7
         lcd.set_cursor(i * 2, 0);  // Set cursor at the first row and column 2*i
         lcd.data(i);  // Display the custom character at position i
         lcd.set_cursor(i * 2, 1);  // Set cursor at the second row and column 2*i
