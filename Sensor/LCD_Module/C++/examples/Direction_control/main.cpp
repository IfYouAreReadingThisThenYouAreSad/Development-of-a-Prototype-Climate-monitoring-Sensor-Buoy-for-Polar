...
extern "C" int main(void)
{
  ...
  lcd.set_cursor(0, 0);
  lcd.left_to_right();  // Set text direction to left-to-right
  ...
  lcd.right_to_left();  // Change text direction to right-to-left for scrolling
  ...
  for (int i = 11; i >= 0; i--) {  // Loop through the "Hello World!" text (backwards)
      if (i < 2) {
          ...
          lcd.set_cursor(x, 0);  // Set cursor to the updated X position
